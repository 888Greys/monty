 ...
 * @line_number: this is the current working line number of
 * a Monty bytecodes file.
 */
void monty_push(stack_t **stack, unsigned int line_number)
{
stack_t *tmp, *new;
 ...
 * @line_number: this is the current working line number
 * of a Monty bytecode file.
 */
void monty_pall(stack_t **stack, unsigned int line_number)
{
 ...
 * stack linked list.
 * @stack: A pointer to the top mode node of the stack linked
 * list.
 * @line_number: this the the current working line number of a
 * Monty bytecode file.
 */
void monty_swap(stack_t **stack, unsigned int line_number)
{
